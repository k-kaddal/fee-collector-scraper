...
import type { LifiContract, LifiContractInterface } from "../LifiContract";
...
export class LifiContract__factory {
  static readonly abi = _abi;
  static createInterface(): LifiContractInterface {
    return new Interface(_abi) as LifiContractInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): LifiContract {
    return new Contract(address, _abi, runner) as unknown as LifiContract;
  }
}
